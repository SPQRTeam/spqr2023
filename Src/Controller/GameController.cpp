...
void GameController::setTeamInfos(
  Settings::TeamColor firstFieldPlayerColour, 
  Settings::TeamColor secondFieldPlayerColour, 
  Settings::TeamColor firstGoalkeeperColour,
  Settings::TeamColor secondGoalkeeperColour)
{
  teamInfos[0].teamNumber = 1;
  teamInfos[0].fieldPlayerColour = firstFieldPlayerColour;
  teamInfos[0].goalkeeperColour = firstGoalkeeperColour;
  teamInfos[1].teamNumber = 2;
  teamInfos[1].fieldPlayerColour = firstGoalkeeperColour;
  teamInfos[1].goalkeeperColour = secondGoalkeeperColour;
}
