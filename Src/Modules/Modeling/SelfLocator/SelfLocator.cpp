...
Pose2f SelfLocator::getNewPoseAtWalkInPosition()
{
  ...
  // std::cout << "@SelfLocator, getNewPoseAtWalkInPosition, theRobotInfo.number = " << theRobotInfo.number << std::endl; //SIM-D
  const int effectivePlayerNumber = theOwnTeamInfo.getSubstitutedPlayerNumber(theRobotInfo.number);

  //std::cout << "EffectivePlayerNumber = " << effectivePlayerNumber << std::endl; //SIM-D
