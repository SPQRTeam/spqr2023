...
class DefenderoneCard : public DefenderoneCardBase
{
  ...
  option
  {
    ...
    state(followBall)
    {
      ...
      action
      {
        Vector2f target = theLibDefender.getDefenderonePosition();
