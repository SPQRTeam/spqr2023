...
#Vincenzo
#set(OP_ENCV_ROOT_DIR "${BHUMAN_PREFIX}/Util/Buildchain/V6/gcc/include/open_cv/include")

#file(GLOB_RECURSE OPEN_CV_SOURCES "${ASMJIT_ROOT_DIR}/*.cpp" "${ASMJIT_ROOT_DIR}/*.h")
...
file(GLOB_RECURSE NAO_SOURCES_ADDITIONAL
 ...
 #   "${OPENCV_ROOT_DIR}/*" # Vincenzo #TODO questo dovrebbe essere tolto da qui
    ) # Vincenzo
list(APPEND NAO_SOURCES ${NAO_SOURCES_ADDITIONAL})
...
#   target_link_libraries(Nao PRIVATE ${Open_CV_LIBS})
