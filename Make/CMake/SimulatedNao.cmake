...
# Vincenzo
# target_include_directories(SimulatedNao SYSTEM PRIVATE ${APP_KIT_FRAMEWORK} ${APP_KIT_FRAMEWORK}/Headers)
#include_directories(SimulatedNao SYSTEM "${BHUMAN_PREFIX}/Util/Buildchain/V6/gcc/include/opencv/include/*")
# Daniele 
target_link_libraries(SimulatedNao PRIVATE ${OpenCV_LIBS})
# end
