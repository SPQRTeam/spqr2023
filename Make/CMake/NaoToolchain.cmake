...
--start-group \"${_v6_lib_dir}/libgcc_s.so.1\" \"${_v6_lib_dir}/libgcc.a\" --end-group \
\"${_v6_lib_dir}/libgcc.a\" \
--start-group  --as-needed \"${_v6_lib_dir}/opencv/libopencv_core.so.3.4.1\" \"${_v6_lib_dir}/opencv/libopencv_objdetect.so.3.4.1\" \"${_v6_lib_dir}/opencv/libopencv_imgproc.so.3.4\" \"${_v6_lib_dir}/opencv/libopencv_imgcodecs.so.3.4.1\"  --no-as-needed --end-group \
\"${_v6_lib_dir}/crtend.o\" \"${_v6_lib_dir}/crtn.o\"")

# riga 36 aggiunta -  Vincenzo
...
#Vincenzo IMPORTANTE
include_directories(SYSTEM "${_v6_include_dir}/opencv/include")
